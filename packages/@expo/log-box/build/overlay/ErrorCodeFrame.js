...
function ErrorCodeFrame({ projectRoot, codeFrame, }) {
    ...
    return (react_1.default.createElement(parseLogBoxLog_1.CodeFrame, { title: react_1.default.createElement(react_1.default.Fragment, null,
            getFileName(),
            react_1.default.createElement("span", { style: { opacity: 0.8 } }, getLocation())), headerIcon: react_1.default.createElement(FileIcon, null), headerAction: react_1.default.createElement("button", { className: ErrorCodeFrame_module_css_1.default.copyButton, type: "button", title: "Open in editor", onClick: () => {
                (0, devServerEndpoints_1.openFileInEditor)(codeFrame.fileName, codeFrame.location?.row ?? 0);
            }, "aria-label": "Copy content" },
            react_1.default.createElement("p", { className: ErrorCodeFrame_module_css_1.default.copyButtonText, "data-text": "true" }, "Open"),
            react_1.default.createElement(OpenIcon, { className: ErrorCodeFrame_module_css_1.default.copyButtonIcon, width: 26, height: 26 })), content: codeFrame.content }));
}
function Terminal({ content, moduleName }) {
    return (react_1.default.createElement(parseLogBoxLog_1.CodeFrame, { title: "Terminal", headerAction: react_1.default.createElement("button", { className: ErrorCodeFrame_module_css_1.default.copyButton, type: "button", title: "Run command in project", onClick: () => {
                // TODO: Stream back progress
                (0, devServerEndpoints_1.installPackageInProject)(moduleName);
            }, "aria-label": "Copy content" },
            react_1.default.createElement("p", { className: ErrorCodeFrame_module_css_1.default.copyButtonText, "data-text": "true" }, "Run"),
            react_1.default.createElement(PlayIcon, { className: ErrorCodeFrame_module_css_1.default.copyButtonIcon, width: 26, height: 26 })), headerIcon: react_1.default.createElement(TerminalIcon, null), content: content }));
}
function CodeFrame({ content, headerIcon, headerAction, title, }) {
    ...
    return (react_1.default.createElement("div", { style: {
        ...
        react_1.default.createElement("header", { className: ErrorCodeFrame_module_css_1.default.header },
            react_1.default.createElement("span", { style: {
                ...
                react_1.default.createElement("span", { ref: scrollTextRef, className: ErrorCodeFrame_module_css_1.default.headerScrollText },
                    react_1.default.createElement("span", { className: ErrorCodeFrame_module_css_1.default.headerIconWrapper, style: {} }, headerIcon),
                    react_1.default.createElement("span", { className: ErrorCodeFrame_module_css_1.default.headerText }, title)),
                react_1.default.createElement("span", { ref: leftBlurRef, className: ErrorCodeFrame_module_css_1.default.blurGradientLR }),
                react_1.default.createElement("span", { className: ErrorCodeFrame_module_css_1.default.blurGradientRL })),
            headerAction),
...
function FileIcon() {
    return (react_1.default.createElement("svg", { fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", style: {
        ...
        }, className: ErrorCodeFrame_module_css_1.default.fileIcon, role: "img" },
...
function TerminalIcon() {
    return (react_1.default.createElement("svg", { fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", style: {
            ...
            height: '1rem',
            color: 'var(--expo-log-secondary-label)',
        }, strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className: ErrorCodeFrame_module_css_1.default.fileIcon, role: "img" },
